...
button_to_select = CTkButton(master=app, text = "Choose file", fg_color = "transparent", command = selectfile,corner_radius=32,border_color="#FFCC70",border_width=2)
button_to_select.pack(padx = 5, pady = 5)
button_to_select.place(relx = 0.4, rely = 0.9,anchor="center")

classify_button=CTkButton(master=app,text="Classify",command=classify,fg_color = "transparent", corner_radius=32,border_color="#FFCC70",border_width=2)
